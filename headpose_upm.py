...
pose_3d_estimation_net = keras.models.load_model('/content/drive/My Drive/FRANK/headpose_estimation_PCR/ls3dw_pcr_upm.hdf5', custom_objects=load_custom_objects('lnds'))
pose_3d_estimation_net.summary()
...
modelFile = "/content/drive/My Drive/FRANK/headpose_estimation_PCR/opencv_face_detector_uint8.pb"
configFile = "/content/drive/My Drive/FRANK/headpose_estimation_PCR/opencv_face_detector.pbtxt"
face_detector_net = cv2.dnn.readNetFromTensorflow(modelFile, configFile)

# Detectar caras:
#file_name = "/content/drive/My Drive/headpose_estimation_PCR/imagenes/Equipo-de-Trabajo-1200x545_c.jpg"
